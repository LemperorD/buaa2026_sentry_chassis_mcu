...
#define Radius 60
//������ֵ������������ǰ��ʱת������ʼ����ֵ
#define DIRMOTOR_LB_ANGLE 4135
#define DIRMOTOR_RB_ANGLE 2700

#define Length_wheel_y 155.49f  //���ӵ����̼������ĵ�y����� (��λ��mm)
...
#define lb_omni_angle 225.0f    //��ǰ�������X��ĽǶ�
#define rb_omni_angle 315.0f    //��ǰ�������X
