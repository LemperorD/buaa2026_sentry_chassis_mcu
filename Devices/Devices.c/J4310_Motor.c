...
void J4310_Enable()
{
  ...
  Can_Send_Data.CAN_TxHeader.DLC = 0x08;                   // 8�ֽ�
...
void J4310_getInfo(Can_Export_Data_t RxMessage)
{
  ...
  StdId = (int32_t)RxMessage.CAN_RxHeader.StdId - J4310_READID_PITCH; //���㿪ʼ
  float P_MAX, V_MAX, T_MAX;
...
/**
  * @brief  �趨J4310�����Ŀ��Ƕ�
  * @param  J4310  ������ݽṹ���ַ 
  *         angle	 ��е�Ƕ�ֵ����Χ 0~8191 ��������0��8191�ᵼ�µ���񵴣�Ҫ�����޷�
  * @retval None
  */
void J4310_setTargetAngle(J4310s_t *J4310, int32_t angle)
{
